...
const XMLFileValidation::st_file_elements XMLFileValidation::m_file_elements[XLE_ELEMENTS] = {
  ...
  {_T("custom_fields"), {0, XLE_CUSTOM_FIELDS}},
  {_T("custom_field"), {0, XLE_CUSTOM_FIELD}},
  {_T("name"), {0, XLE_CUSTOM_FIELD_NAME}},
  {_T("value"), {0, XLE_CUSTOM_FIELD_VALUE}},
  {_T("sensitive"), {0, XLE_CUSTOM_FIELD_SENSITIVE}},
