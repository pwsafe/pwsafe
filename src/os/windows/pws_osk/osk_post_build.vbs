...
Sub CopyFile(strDLL, strInfile, strOutfile, strOutDir)
...
If bOutputFileExists = True Then
  ...
  If objInfile.DateLastModified > objOutfile.DateLastModified Then
     ...
     stdout_CF.WriteLine " >>> DLL: '" & strDLL & "' copied successfully to directory: " & strOutDir
  Else
    stdout_CF.WriteLine " >>> DLL: '" & strDLL & "' not copied to directory: " & strOutDir & ", already up to date."
  End If
Else
