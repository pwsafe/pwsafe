...
' This script is for setting up Visual Studio 2017.
...
' Note: the 15.0 in the Xerces directory corresponds to VS2017
...
' Set defaults
strXercesDir = "C:\Program Files" & strPgmFiles & "\xerces-c-3.1.4-x86-windows-vc-15.0"
strXerces64Dir = "C:\Program Files\xerces-c-3.1.4-x86_64-windows-vc-15.0"
strWXDir = "C:\Program Files" & strPgmFiles & "\wxWidgets-3.0.2"
strWDKDir = "C:\Program Files (x86)\Windows Kits\10"
strGtestIncDir = "C:\...\gtest-1.7.0\include"
strGtestLibDir = "C:\...\gtest-1.7.0\build-vc15"
...
strOutputFile = "UserVariables-15.props"
...
Call MsgBox("File UserVariables-15.props created successfully", 0, "Configure User Variables")
Set objFileSystem = Nothing
WScript.Quit(0)

Sub CancelExit
  Call MsgBox("File UserVariables-15.props was not created/changed", 0, "Configure User Variables")
  Set objFileSystem = Nothing
WScript.Quit(0)
End Sub
