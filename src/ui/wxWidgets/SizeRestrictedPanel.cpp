...
//    wxLogDebug(L"Adjusting best width from %d, screen width is %d, parent width is %d, current width is %d, diff is %d",
...
//    wxLogDebug(L"Adjusting best height from %d, screen height is %d, parent height is %d, current height is %d, diff is %d",
