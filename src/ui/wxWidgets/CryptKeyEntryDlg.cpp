...
void CryptKeyEntryDlg::CreateControls()
{
    ...
    showHideButtonKey->Bind(wxEVT_BUTTON, [&, hBoxSizer1, showHideButtonKey](wxCommandEvent& WXUNUSED(event)) {
    ...
    if (IsEncryptionMode()) {
      ...
      showHideButtonVerificationKey->Bind(wxEVT_BUTTON, [&, hBoxSizer2, showHideButtonVerificationKey](wxCommandEvent& WXUNUSED(event)) {
