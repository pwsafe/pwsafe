...
void PasswordSafeFrame::RegisterLanguageMenuItems() {
  ...
  AddLanguage( ID_LANGUAGE_CHINESE,   wxLANGUAGE_CHINESE_SIMPLIFIED, L"Chinese"  );  /* code: 'zh_CN' */
  ...
  AddLanguage( ID_LANGUAGE_KOREAN,    wxLANGUAGE_KOREAN_KOREA,       L"Korean"   );  /* code: 'ko_KR' */
#else
