...
// Edit Menu
   ...
   ON_COMMAND(ID_MENUITEM_MOVEGROUPTOTOPLEVEL, MoveGroupToTopLevel)
   ON_UPDATE_COMMAND_UI(ID_MENUITEM_MOVEGROUPTOTOPLEVEL, OnUpdateROCommand)//Note that if this is not included then in ReadOnly mode the option is not greyed out (upon right click)
