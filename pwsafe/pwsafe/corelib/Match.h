...
namespace PWSMatch {
  ...
  bool Matches(CMyString string1, CMyString &csValue,
               const int &iFunction);
  bool Matches(const int &num1, const int &num2, const int &iValue,
               const int &iFunction);
  bool Matches(const time_t &time1, const time_t &time2, const time_t &tValue,
               const int &iFunction);
  bool Matches(const bool bValue,
