...
<!--
  ...
  Therefore this XSLT code first changes any dot in the group or title files to
  a forward slash ('/') and then any backward slashes to dots.  This will create the correct
  group path in PasswordSafe but any dots in the original group and title fields
  will remain a forward slash.
