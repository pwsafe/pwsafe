...
function(harden_add_compile_definition FLAG_NAME FLAG_VALUE RELEASE_ONLY)
  set(FLAG "${FLAG_NAME}=${FLAG_VALUE}")
  if (CMAKE_CXX_FLAGS MATCHES "${FLAG_NAME}")
    message(VERBOSE "Compile hardening flag ${FLAG_NAME} already present, skipping")
  else ()
