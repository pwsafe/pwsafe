...
ON_COMMAND_RANGE(ID_MENUITEM_REPORT_IMPORTTEXT, ID_MENUITEM_REPORT_VALIDATE, OnViewReports)
ON_UPDATE_COMMAND_UI_RANGE(ID_MENUITEM_REPORT_IMPORTTEXT, ID_MENUITEM_REPORT_VALIDATE, OnUpdateViewReports)
