...
* [SF1636](https://sourceforge.net/p/passwordsafe/bugs/1636/) Minor UI issues in Custom Values display (column width) and edit (use correct font).
...
* Password text wasn't centered correctly on displays with scaling other than 100%.
* [GH1845](https://github.com/pwsafe/pwsafe/issues/1845), [SF1629](https://sourceforge.net/p/passwordsafe/bugs/1629/) All check boxes and radio buttons displayed correctly on scaled displays (regression).
* [GH1842](https://github.com/pwsafe/pwsafe/issues/1842), [SF1632](https://sourceforge.net/p/passwordsafe/bugs/1632/) Notes Word Wrap is handled correctly again (regression).
