...
Alternatively - you can run the "Create_wxWidgetsHelp.bat" file to create one or all of these help zip files.
It either takes one parameter - the lanugauge e.g. RU or, if no parameter is given, it will create all the files.
